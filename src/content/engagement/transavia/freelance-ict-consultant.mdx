---
mission: Replacing legacy AS-400 systems with Azure serverless, saving €48k/year in mainframe costs
position: Freelance Senior ICT Consultant
startDate: 2023-04-15
endDate: 2026-12-31
img: airplane.webp
imgAlt: Airplane flux - Created with OpenArt.ai
description: |
...
impact: |
    - Replaced AS-400 crew evaluation tool with Azure serverless, saving €48k/year in mainframe costs
    - Automated crew compensation with .NET Aspire & Durable Functions, saving 1 FTE
    - Drove Copilot/GenAI adoption and upskilled teams in agentic workflows
    - Guided teams through Zero Trust Azure estate migration with the CCoE
    - Hardened external B2B API security and resolved third-party integration risks
location: Schiphol, The Netherlands
selectedWork: true
employment: Freelancer
employer: Transavia
employerSite: https://www.transavia.com/
sectorTitle: Aviation & Travel Sector
sectorIcon: airplane-tilt
tags:
